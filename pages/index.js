            ...
            <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
                ...
                <main className="container mx-auto px-4 py-4 sm:px-6 lg:px-8">
                    ...
                    <div className="space-y-4">
                        {/* 单位管理区域 */}
                        <div className={`transition-all duration-300 overflow-hidden bg-white rounded-xl shadow-lg ${
                            showUnitManager ? 'max-h-[1000px] opacity-100 transform translate-y-0' : 'max-h-0 opacity-0 transform -translate-y-4'
                        }`}>
                            <UnitManager 
                        ...
                        {/* 单位转换区域 */}
                        <div className={`transition-all duration-300 overflow-hidden bg-white rounded-xl shadow-lg ${
                            showConverter ? 'max-h-[2000px] opacity-100 transform translate-y-0' : 'max-h-0 opacity-0 transform -translate-y-4'
                        }`}>
                        ...
                        <div className="bg-white rounded-xl shadow-lg overflow-hidden">
                            <div className="p-6">
                                ...
                                <div className={`transition-all duration-300 ${
                                    showAddForm ? 'max-h-[1000px] opacity-100' : 'max-h-0 opacity-0 overflow-hidden'
                                }`}>
                    ...
                    <div className="container mx-auto px-4 py-8">
                        <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
                            ...
                            <div className="flex space-x-6">
                                <a href="#" className="text-gray-600 hover:text-blue-600 transition-colors">使用指南</a>
                                <a href="#" className="text-gray-600 hover:text-blue-600 transition-colors">关于我们</a>
                                <a href="#" className="text-gray-600 hover:text-blue-600 transition-colors">联系我们</a>
                            </div>
        </div>
    </div>
                </footer>
